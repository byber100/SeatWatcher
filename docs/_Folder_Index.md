...
- `00_프로젝트_설계기준.md`: 현재 요구사항, 아키텍처, 설정 분리, Git 운영, 철도 네이버 지도 기차 비로그인 직통 공급자·KORAIL 모바일 환승 보조 공급자·target별 직통/열차종 필터, 좌석 변동/Kakao/Pushover 알림·무유음 강제 정책·단독 테스트 규칙, polling 성능 규칙, 검증 기준을 유지하는 개발 협업 SSOT
