...
- `rail_provider.py`: KORAIL 익명 읽기 전용 직통/환승을 1순위로 조회하고, 직통 KORAIL 장애 시 NAVER degraded fallback과 1시간 재시험 cooldown을 적용. 비공개 target별 `direct_only`, `train_type_prefix` 필터 지원
